...
data class TerminalInformationRequestKozen (
    ...
    var uniqueId: String = "",
      ...
      fun fromTerminalInfo(
          ...
          haspin: Boolean
      ): TerminalInformationRequestKozen {
          val battery = "-1"
          val date = DateUtils.universalDateFormat.format(Date())

          return TerminalInformationRequestKozen().apply {
              ...
              uniqueId = DeviceUtilsKozen.getDeviceSerialKozen().toString()
