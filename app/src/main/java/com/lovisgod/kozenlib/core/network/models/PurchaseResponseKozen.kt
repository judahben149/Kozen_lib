...
@Parcelize
data class PurchaseResponseKozen(
...
//    val inquiryResponse: InquiryResponse? = null,
    ...
    var remoteResponseCode: String = ""):Parcelable
        ...
        fun fromResponseData(transactionResultData: TransactionResultData?): PurchaseResponseKozen {
             return transactionResultData.let { response ->
                return@let PurchaseResponseKozen(
